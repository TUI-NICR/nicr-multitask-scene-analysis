...
- add `MPSSafePermute` workaround for incorrect MPS conv results with Swin NHWC -> NCHW transitions
  on torch < 2.12, see https://github.com/pytorch/pytorch/issues/180984
